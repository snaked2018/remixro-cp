...
</div> <!-- This closes the flex-grow div from main.php -->
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div>
                ...
                <ul role="list" class="mt-6 space-y-4">
                    <li>
                        <a href="<?php echo $this->url('rmx&action=download') ?>" class="text-sm leading-6 text-gray-300 hover:text-purple-400 transition">
                            Download
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $this->url('rmx&action=rules') ?>" class="text-sm leading-6 text-gray-300 hover:text-purple-400 transition">
                            Rules
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $this->url('donate') ?>" class="text-sm leading-6 text-gray-300 hover:text-purple-400 transition">
                            Donate
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <div class="mt-6 flex gap-6">
                    <a href="http://fb.com/remixragnarokonline" class="text-gray-400 hover:text-purple-400 transition">
                        <span class="sr-only">Facebook</span>
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                        </svg>
                    </a>
                    <a href="https://discord.com/invite/wd96YwpW?utm_source=Discord%20Widget&utm_medium=Connect" class="text-gray-400 hover:text-purple-400 transition">
