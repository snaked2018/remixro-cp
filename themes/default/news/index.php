...
<div class="py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-400">Stay updated with the latest announcements and updates.</p>
        </div>
        ...
        <?php if($newstype == '1' && $news): ?>
                                ...
                                <div class="relative mt-8 flex items-center justify-between w-full">
                                    ...
                                    <button onclick="openNewsModal(<?php echo htmlspecialchars(json_encode([
                                        ...
                                        'link' => $nrow->link
                                            ...
                                            class="news-btn inline-flex items-center px-4 py-2 branding-green-button text-sm font-medium rounded-md">
            ...
            <div id="newsModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
                <div class="flex items-center justify-center min-h-screen px-4">
                    ...
                    <div class="relative bg-gray-900 rounded-lg max-w-3xl w-full mx-auto p-6">
