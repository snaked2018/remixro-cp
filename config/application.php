...
return array(
	...
	'SiteTitle' => 'RemixRO',	// This value is only used if the theme decides to use it.
	'ThemeName' => array('tailwind'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
	...
	'ReCaptchaPublicKey' => '6LfPYuEqAAAAADHTTLn1KekwCYOXBC8i97R5HDPz',					// This is your reCAPTCHA public key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
	'ReCaptchaPrivateKey' => '6LfPYuEqAAAAAEQNnFqq0xLG39PF4WM5UFfA8mnB',					// This is your reCAPTCHA private key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
	'ReCaptchaTheme' => 'dark',					// ReCaptcha theme to use (Value: dark or light) (see: https://developers.google.com/recaptcha/docs/display#render_param)
	...
	'SecuritySettings' => array(
		'SessionTimeout' => 600,      // Session timeout in seconds (10 minutes)
		'EnableCSRFToken' => true,     // Enable CSRF token protection
		'TokenExpiry' => 600,      // Token expiry time in seconds
		'MaxLoginAttempts' => 5,        // Maximum failed login attempts
		'LockoutDuration' => 900,      // Account lockout duration in seconds (15 minutes)
	),
	...
	'MenuItems' => array(
		...
		'InformationLabel' => array(
			...
			'MeetTheStaffLabel' => array('module' => 'rmx', 'action' => 'team'),
			'ServerRulesLabel' => array('module' => 'rmx', 'action' => 'rules'),
		),
		'DatabaseLabel' => array(
